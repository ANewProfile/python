...
first_names = ["Liam", "Grayson", "Jaina", "Cassandra", "Ozzy", "Teddy", "Skyler", "Theo", "Truman"]
last_names = ["O\'riain", "Bardin", "Considine", "Olszewski", "Chen", "Palchik", "Ferguson", "Kokones", "Hibbard"]
count=0
name = ""
